...
export function Checkbox({
  ...
  return (
    <label
      htmlFor={id}
      className={cn(
        "motion-checkbox-wrapper",
        disabled ? "motion-checkbox-disabled" : "",
        className,
      )}
    >
      <motion.button
        ...
        className={cn(
          "motion-checkbox-box",
          showMark ? "motion-checkbox-checked" : "motion-checkbox-unchecked",
        )}
      >
      ...
      {label ? (
        <span className={cn("motion-checkbox-label", disabled && "opacity-60")}>
          {label}
        </span>
      ) : null}
    </label>
