  ...
  return (
    ...
    >
      <span
        ref={measureRef}
        aria-hidden
        className="stateful-text-measure invisible inline-block whitespace-nowrap"
        style={{
          visibility: "hidden",
          pointerEvents: "none",
          display: "inline-flex",
      ...
      >
        {cascade
          ? label.split("").map((char, index) => (
              <span
                key={index}
                className="stateful-letter inline-block whitespace-pre"
        ...
        <>
          ...
          <AnimatePresence initial={false}>
            <motion.span
              ...
              animate="animate"
              exit="exit"
              className="stateful-text-visible"
              style={{
                position: "absolute",
                inset: 0,
                display: "inline-flex",
