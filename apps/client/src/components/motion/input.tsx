...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <div
      className={cn("motion-input-group", className, classNames?.root)}
    >
      {label ? (
        <label
          htmlFor={id}
      ...
      <div
        ...
        className={cn(
          "motion-input-field",
          focused && !hasError && "motion-input-focused",
          hasError && "motion-input-error",
          disabled && "motion-input-disabled",
          classNames?.field,
        )}
      >
        {leftIcon ? (
        ...
        <input
          ...
          className={cn(
            "motion-input-element",
            leftIcon ? "has-left-icon" : "",
            rightSlot || success ? "has-right-icon" : "",
            classNames?.input,
          )}
        />
      ...
      <div className={reserveErrorLine ? "motion-input-error-reserve" : "motion-input-error-compact"}>
